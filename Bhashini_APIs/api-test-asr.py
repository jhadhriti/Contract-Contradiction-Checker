...
def asr(path: str, lang:str):
    encode_string = base64.b64encode(open(path, "rb").read()).decode()
    ...
    print(compute_response.json()["pipelineResponse"])
